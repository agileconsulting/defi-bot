...
class BaseContract {
    ...
    constructor(contractName, abi, address, supportedProvider, callAndTxnDefaults, logDecodeDependencies, deployedBytecode) {
    ...
    _applyDefaultsToTxDataAsync(txData, estimateGasAsync) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const txDataWithDefaults = Object.assign({ to: this.address }, this._web3Wrapper.getContractDefaults(), BaseContract._removeUndefinedProperties(txData));
            if (txDataWithDefaults.gas === undefined && estimateGasAsync !== undefined) {
                txDataWithDefaults.gas = yield estimateGasAsync(txDataWithDefaults);
            }
            if (txDataWithDefaults.from !== undefined) {
