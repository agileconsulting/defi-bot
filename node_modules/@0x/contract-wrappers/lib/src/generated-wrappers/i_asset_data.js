...
class IAssetDataContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = IAssetDataContract.deployedBytecode) {
        super('IAssetData', IAssetDataContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
    ...
    static deployWithLibrariesFrom0xArtifactAsync(artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const libraryAddresses = yield IAssetDataContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults);
    ...
    static deployAsync(bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contractInstance = new IAssetDataContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
            ...
            for (const link of Object.values(links)) {
                for (const libraryName of Object.keys(link)) {
                    if (!libraryAddresses[libraryName]) {
                        ...
                        yield IAssetDataContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses);
                        // Deploy this library.
    ...
    getFunctionSignature(methodName) {
        ...
        const methodAbi = IAssetDataContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
     ...
     */
    ERC1155Assets(tokenAddress, tokenIds, values, callbackData) {
        const self = this;
     ...
     */
    ERC20Bridge(tokenAddress, bridgeAddress, bridgeData) {
        const self = this;
        assert_1.assert.isString('tokenAddress', tokenAddress);
     ...
     */
    ERC721Token(tokenAddress, tokenId) {
        const self = this;
        assert_1.assert.isString('tokenAddress', tokenAddress);
     ...
     */
    MultiAsset(values, nestedAssetData) {
        const self = this;
        assert_1.assert.isArray('values', values);
